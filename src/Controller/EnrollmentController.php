...
require('/var/www/vhosts/evgb.de/beta.evgb.de/packages/evgb-de/pk-enrollment/src/Mail/PHPMailer.php');
require('/var/www/vhosts/evgb.de/beta.evgb.de/packages/evgb-de/pk-enrollment/src/Mail/SMTP.php');
require('/var/www/vhosts/evgb.de/beta.evgb.de/packages/evgb-de/pk-enrollment/src/Mail/Exception.php');
...
class EnrollmentController
{
  ...
  */
  public function saveAction($entry = [])
  {
    ...
    $mail->From = '';
    $mail->FromName = 'Zeltlager Anmeldung';
